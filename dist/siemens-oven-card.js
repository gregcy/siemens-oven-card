 ...
 */function gt(t){return pt({...t,state:!0,attribute:!1})}const ut={"Cooking.Oven.Program.HeatingMode.HotAir":"hot-air.svg","Cooking.Oven.Program.HeatingMode.TopBottomHeating":"top-bottom.svg","Cooking.Oven.Program.HeatingMode.HotAirEco":"hot-air-eco.svg","Cooking.Oven.Program.HeatingMode.TopBottomHeatingEco":"top-bottom-eco.svg","Cooking.Oven.Program.HeatingMode.HotAirGrilling":"hot-air-grill.svg","Cooking.Oven.Program.HeatingMode.PizzaSetting":"pizza.svg","Cooking.Oven.Program.HeatingMode.SlowCook":"slow-cook.svg","Cooking.Oven.Program.HeatingMode.BottomHeating":"bottom-heat.svg","Cooking.Oven.Program.HeatingMode.KeepWarm":"keep-warm.svg","Cooking.Oven.Program.HeatingMode.PreheatOvenware":"preheat-ovenware.svg","Cooking.Oven.Program.HeatingMode.FrozenHeatupSpecial":"frozen.svg","Cooking.Oven.Program.HeatingMode.SabbathProgramme":"sabbath.svg","Cooking.Oven.Program.HeatingMode.GrillLargeArea":"grill-large.svg","Cooking.Oven.Program.HeatingMode.GrillSmallArea":"grill-small.svg"},_t={"Cooking.Oven.Program.HeatingMode.HotAir":"4D Hot air","Cooking.Oven.Program.HeatingMode.TopBottomHeating":"Top and bottom heat","Cooking.Oven.Program.HeatingMode.HotAirEco":"Hot air eco","Cooking.Oven.Program.HeatingMode.TopBottomHeatingEco":"Top and bottom heat eco","Cooking.Oven.Program.HeatingMode.HotAirGrilling":"Hot air grilling","Cooking.Oven.Program.HeatingMode.PizzaSetting":"Pizza setting","Cooking.Oven.Program.HeatingMode.SlowCook":"Low-temperature cooking","Cooking.Oven.Program.HeatingMode.BottomHeating":"Bottom heat","Cooking.Oven.Program.HeatingMode.KeepWarm":"Keep warm","Cooking.Oven.Program.HeatingMode.PreheatOvenware":"Plate warming","Cooking.Oven.Program.HeatingMode.FrozenHeatupSpecial":"coolStart function","Cooking.Oven.Program.HeatingMode.SabbathProgramme":"Sabbath mode","Cooking.Oven.Program.HeatingMode.GrillLargeArea":"Grill, large area","Cooking.Oven.Program.HeatingMode.GrillSmallArea":"Grill, small area"};function mt(t){if(t>=3600){const e=Math.floor(t/3600),i=Math.floor(t%3600/60);return`${String(e).padStart(2,"0")}:${String(i).padStart(2,"0")} min`}const e=Math.floor(t/60),i=t%60;return`${String(e).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function ft(t){if(!t||"unavailable"===t||"unknown"===t)return null;const e=t.split(":");if(2!==e.length)return null;const i=parseInt(e[0],10),s=parseInt(e[1],10);return isNaN(i)||isNaN(s)?null:3600*i+60*s}const vt=["run","pause"];function yt(t,e){const i=t.states[e.program_progress_entity]?.state;if(!i||"unavailable"===i||"unknown"===i)return null;const s=parseInt(i,10);return isNaN(s)||s>=100?null:s}const $t=[{key:"operation_state_entity",label:"Operation State Entity"},{key:"active_program_entity",label:"Active Program Entity"},{key:"remaining_time_entity",label:"Remaining Time Entity"},{key:"elapsed_time_entity",label:"Elapsed Time Entity (unused — kept for compatibility)"},{key:"cavity_temp_entity",label:"Cavity Temperature Entity"},{key:"setpoint_temp_entity",label:"Setpoint Temperature Entity"},{key:"program_progress_entity",label:"Program Progress Entity"},{key:"door_entity",label:"Door Entity (binary_sensor)"},{key:"remote_control_entity",label:"Remote Control Entity (optional, binary_sensor)"},{key:"connected_entity",label:"Connected Entity (optional, binary_sensor)"},{key:"childlock_entity",label:"Child Lock Entity (optional, binary_sensor)"}];let bt=class extends at{setConfig(t){this._config=t}_entityChanged(t){if(!this._config)return;const e=t.target.getAttribute("data-key");if(!e)return;const i={...this._config,[e]:t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}_nameChanged(t){if(!this._config)return;const e={...this._config,name:t.target.value||void 0};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e}}))}_resourcesPathChanged(t){if(!this._config)return;const e=t.target.value.trim(),i={...this._config,resources_path:e||void 0};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}render(){return this._config?q`
  ...
  `}};t([pt({attribute:!1})],bt.prototype,"hass",void 0),t([pt({attribute:!1})],bt.prototype,"_config",void 0),bt=t([ct("siemens-oven-card-editor")],bt),window.customCards??=[],window.customCards.push({type:"siemens-oven-card",name:"Siemens Oven Card",description:"Card for Siemens Home Connect ovens",preview:!1}),console.info("%c SIEMENS-OVEN-CARD %c v0.1.0 ","background:#8df427;color:#000;font-weight:bold;","background:#555;color:#fff;");let At=class extends at{constructor(){super(...arguments),this._tick=0,this._lastTimerDisplay="",this._prevOpState=null,this._lastRemainingSeconds=null,this._lastElapsedUpdated=null,this._lastElapsedSeconds=null,this._resumeTime=null,this._resumeBaseSeconds=null,this._lastTotalElapsedSeconds=null}get _resourcesPath(){return this._config?.resources_path??"/hacsfiles/siemens-oven-card"}setConfig(t){const e=["operation_state_entity","active_program_entity","remaining_time_entity","cavity_temp_entity","setpoint_temp_entity","program_progress_entity","door_entity"];for(const i of e)if(!t[i])throw new Error(`siemens-oven-card: missing required config field: ${i}`);this._config=t}static getConfigElement(){return document.createElement("siemens-oven-card-editor")}static getStubConfig(){const t="siemens_hb676g5s6_68a40e6a233e";return{operation_state_entity:`sensor.${t}_bsh_common_status_operationstate`,active_program_entity:`sensor.${t}_active_program`,remaining_time_entity:`sensor.${t}_bsh_common_option_remainingprogramtime`,elapsed_time_entity:`sensor.${t}_bsh_common_option_elapsedprogramtime`,cavity_temp_entity:`sensor.${t}_cooking_oven_status_currentcavitytemperature`,setpoint_temp_entity:`sensor.${t}_cooking_oven_option_setpointtemperature`,program_progress_entity:`sensor.${t}_bsh_common_option_programprogress`,door_entity:`binary_sensor.${t}_bsh_common_status_doorstate`}}getCardSize(){return 3}_renderZone2(t){if("error"===t||"actionrequired"===t)return q`
      ...
      `;if("inactive"===t||"finished"===t||"aborting"===t)return q`<div class="zone-icon"></div>`;const e=this.hass.states[this._config.active_program_entity]?.state??"",i=function(t,e){const i=ut[t];return i?`${e}/images/${i}`:null}(e,this._resourcesPath),s=_t[e]??"";if(!i)return q`<div class="zone-icon"></div>`;return q`
      <div class="zone-icon">
        <img
